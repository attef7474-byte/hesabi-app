...
(function(){
  ...
  function apkInstallReadiness(){
    ...
    if(!runtimeState.ok) warnings.push("نسخة runtime أو APP_VERSION لا تطابق 1.0.102 / build 102.");
    if(!updateState.ok) warnings.push("ملف android-update.json المخزن لا يطابق 1.0.102 / build 102.");
