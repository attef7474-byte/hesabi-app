...
(function(){
  ...
  function apkInstallReadiness(){
    ...
    if(!runtimeState.ok) warnings.push("نسخة runtime أو APP_VERSION لا تطابق 1.0.93 / build 93.");
    if(!updateState.ok) warnings.push("ملف android-update.json المخزن لا يطابق 1.0.89 / build 89.");
